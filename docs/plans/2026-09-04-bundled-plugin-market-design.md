...
> 状态：implemented；插件设备范围与完整控制面已由 `2026-09-07-device-plugin-control-plane-design.md` 扩展（2026-09-07）
...
用户导入插件的代码以及安装、更新、卸载事实按设备共享，导入后所有账号默认启用；账号可以保留自己的禁用覆盖。插件配置、密钥、缓存、会话和业务资产仍按当前账号隔离。完整规则以 `2026-09-07-device-plugin-control-plane-design.md` 为准。
