...
describe('authenticated single-sidebar integration contract', () => {
  ...
  it('prepares a version-five Profile with protected first-party integration', async () => {
    ...
    expect(prepare).toContain("const SIDEBAR_VERSION = '0.19.1'")
    expect(prepare).toContain("const MARKET_VERSION = '1.46.1'")
    expect(prepare).toContain("const DEFAULT_PROFILE_VERSION = 5")
