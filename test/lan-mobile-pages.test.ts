...
describe('LAN mobile page', () => {
  ...
  it('uses the DSH brand color and follows system dark mode', () => {
    ...
    expect(html).toContain('body.chat-open .shell{padding-top:env(safe-area-inset-top)}')
    expect(html).toContain('.chat-toolbar{min-height:40px;padding:0;background:transparent}')
